...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/ConcectPart2.png", __ASSET__assets_concectpart2_png);
		type.set ("assets/ConcectPart2.png", AssetType.IMAGE);
		className.set ("assets/Concept.png", __ASSET__assets_concept_png);
		...
		type.set ("assets/music/ClairdeLune.mp3", AssetType.MUSIC);
		className.set ("assets/music/music-goes-here.txt", __ASSET__assets_music_music_goes_here_txt);
		type.set ("assets/music/music-goes-here.txt", AssetType.TEXT);
		className.set ("assets/sounds/sounds-go-here.txt", __ASSET__assets_sounds_sounds_go_here_txt);
		type.set ("assets/sounds/sounds-go-here.txt", AssetType.TEXT);
		className.set ("assets/thumbnail.PNG", __ASSET__assets_thumbnail_png);
		type.set ("assets/thumbnail.PNG", AssetType.IMAGE);
		...
		var id;
		id = "assets/ConcectPart2.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/Concept.png";
		path.set (id, id);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/music/ClairdeLune.mp3";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_thumbnail_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/thumbnail.PNG") #if display private #end class __ASSET__assets_thumbnail_png extends lime.graphics.Image {}
