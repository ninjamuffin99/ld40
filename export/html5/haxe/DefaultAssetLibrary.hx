...
@:keep @:bind #if display private #end class __ASSET__assets_images_arrow_ase extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_cursor_ase extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_music_clairdelune_mp3 extends null { }
